...
public class Mypanel extends JPanel implements KeyListener, Runnable {
    ...
    public Mypanel(String key) {
        ...
        //将MyPanel对象的 havebombenemyTanks 设置给 Recorder 的 havebombenemyTanks
        Recorder.setHavebombenemyTanks(havebombenemyTanks);
        //将MyPanel对象的 herotank 设置给 Recorder 的 herotank
        Recorder.setHeroTank(heroTank);
        //读取recordfile至nodes
        enemyTanks = Recorder.Deserialize_Live_EnenmyTank();
        //读取recordfile_hashitted至havebombenemyTanks
        havebombenemyTanks = Recorder.Deserialize_HasHitted_EnenmyTank();
        //读取recordfile_herotank至herotank
        heroTank = Recorder.Deserialize_HeroTank();
        //System.out.println("herotank读取结果：" + heroTank);
        ...
        switch (key) {
            case "1"://新开游戏
                ...
                //新建自己坦克的对象
                heroTank = new HeroTank(600, 100, 0, 5);
                Recorder.setHeroTank(heroTank);
        ...
        //播放音乐
        new AePlayWave("D:\\工程师之路\\韩顺平学java\\TankGame002\\src\\com\\company\\TankGame5\\music\\111.wav").start();
    }
    ...
    public void showInfo(Graphics g) {
        ...
        g.drawString(havebombenemyTanks.size() + "", 1080, 100);
    }
